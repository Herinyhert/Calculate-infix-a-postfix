...
const action ={
    [OPERATORS.DIVIDE]: (leftNumber: number, rightNumber: number) => leftNumber / rightNumber,
    [OPERATORS.PLUS]: (leftNumber: number, rightNumber: number) => leftNumber + rightNumber,
    [OPERATORS.MINUS]: (leftNumber: number, rightNumber: number) => leftNumber - rightNumber,
    [OPERATORS.MULTIPLY]: (leftNumber: number, rightNumber: number) => leftNumber * rightNumber,
    [OPERATORS.MODULE]: (leftNumber: number, rightNumber: number) => leftNumber % rightNumber,
    [OPERATORS.POW]: (leftNumber: number, rightNumber: number) => Math.pow(leftNumber, rightNumber),
